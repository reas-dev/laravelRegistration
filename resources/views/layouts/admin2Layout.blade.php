...
<body class="grey lighten-4">
    ...
    <ul id="competition_controllll" class="dropdown-content">
        <li><a href="{{ url('admin/the-day/absent') }}">Absent</a></li>
        <li><a href="{{ url('admin/the-day/certified') }}">Ambil Sertifikat</a></li>
    </ul>
    ...
    <ul id="competition_controlll" class="dropdown-content">
      ...
      <ul class="sidenav indigo darken-4" id="mobile-demo">
          <div class="background">
            <li><a class="waves-effect white-text text-indent" href="{{ url('admin/the-day/absent') }}">Absent</a></li>
            <li><a class="waves-effect white-text text-indent" href="{{ url('admin/certified') }}">Ambil Sertifikat</a></li>
