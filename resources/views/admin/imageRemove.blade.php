...
@section('panel_name', 'Hapus Bukti Pembayaran')
            ...
            <table class="responsive-table centered highlight">
                ...
                <tbody>
                    ...
                    {{-- @endif --}}
                        ...
                        <td>
                            <form action="{{ url('admin/imageRemove/'.$participant->id) }}" method="post" class="d-inline">
                                @csrf
                                <button class="btn waves-effect red accent-3 waves-light tooltipped" data-position="top"
                                    data-tooltip="Hapus Gambar" type="submit" name="action">
                                    <i class="material-icons center">broken_image</i>
                                </button>
                            </form>
                        </td>
                    </tr>
