...
@section('panel_name', 'Absent Peserta')
            ...
            <table class="responsive-table centered highlight">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ url('admin/the-day/certified/'.$participant->id) }}" method="post" class="d-inline">
                                @csrf
                                <button class="btn waves-effect  purple darken-4 waves-light tooltipped" data-position="top"
                                    data-tooltip="Ambil Sertifikat" type="submit" name="action">
